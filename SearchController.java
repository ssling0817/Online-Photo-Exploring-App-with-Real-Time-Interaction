...
public class SearchController {
    ...
    void nextPressed(ActionEvent event) throws Exception 
	{
		if((pagePhotoStatus+1+16*(totalpagenum-pagenum)<=photoNum)&&pagenum!=totalpagenum)
		{
			...
			for(int k=0;k<16;k++)
			{
				...
				image=sqlcon.SelectWordTable(search,pagePhotoStatus,photoIndex);
				int num;
				for(int i=0;i<16;i++)
				{
					num=i+1;
	...
	public void setStage(Stage stage,HomepageController homepagec,Search s,String search)throws Exception
	{
		this.stage=stage;
		...
		int num;
		int picNum=sqlcon.getSearchCount(search);
		System.out.println("search:"+picNum);
		photoNum=picNum;
		photoIndex=photoNum%16;
		...
		image=sqlcon.SelectWordTable(search,pagePhotoStatus,photoIndex);
		//image=sqlcon.SelectWordTable(account,pagePhotoStatus,photoIndex);

		if(picNum<16)
		{
			//Image[]	image = new Image[picNum];
			//image=sqlcon.SelectTable();/////////take
	...
	/*
	public void setSearch(String s)throws Exception
	{
		...
		{
			Image[]	image = new Image[picNum];
			image=sqlcon.searchWord(search);/////////take
			for(int i=0;i<picNum;i++)
			{
				num=i+1;
				switch(num)
	...
	void imageView1Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,0,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView2Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,1,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView3Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,2,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView4Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,3,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView5Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,4,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView6Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,5,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView7Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,6,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView8Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,7,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView9Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,8,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView10Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,9,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView11Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,10,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView12Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,11,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView13Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,12,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView14Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,13,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView15Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,14,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
	void imageView16Clicked(MouseEvent event) throws Exception{ 
		SearchInfo photoInfo=new SearchInfo();
		photoInfo.showWindow(homepagec,15,this,pagePhotoStatus,photoIndex,search);
		((Node)(event.getSource())).getScene().getWindow().hide();
    }
