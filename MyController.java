...
public class MyController {
    ...
    void nextPressed(ActionEvent event) throws Exception{
		...
		if((pagePhotoStatus+1+16*(totalpagenum-pagenum)<=photoNum)&&pagenum!=totalpagenum)
		{
			...
			totalPageLabel.setText(String.valueOf(totalpagenum));
				...
				image=sqlcon2.SelectTable(pagePhotoStatus,photoIndex,account);
				int num;
				for(int i=0;i<16;i++)
				{
					num=i+1;
	...
	public void setStage(Stage stage, HomepageController home,My my)throws Exception
	{
		this.my=my;
		this.homepagec=home;
		this.stage=stage;
		...
		//System.out.println("mycon "+photoNum);
		//System.out.println("mycon "+pagenum+" "+totalpagenum);
		currentPageLabel.setText(String.valueOf(pagenum));
		totalPageLabel.setText(String.valueOf(totalpagenum));
		//Image[]	image;
		...
		image=sqlcon2.SelectTable(pagePhotoStatus,photoIndex,account);/////////take
/*
		if(picNum<16)
		{
